...
const TutorialsCmp: FC<Props> = ({ tutorials, src, name, color, shadow, text }) => {
  return (
    <section
      className={`flex flex-col justify-around items-center w-full ${tutorials.length > 3 ? 'h-full' : 'h-screen'}  bg-gradient-to-b from-black to-gray-800 overflow-auto scrollbar-hide pt-96 pb-4 md:pt-10 mx-auto px-16`}
    >
